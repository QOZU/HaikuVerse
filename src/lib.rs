...
#[derive(Debug)]
pub struct HaikuVerseProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HaikuVerseProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HaikuVerse processing");
    
    let mut processor = HaikuVerseProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HaikuVerseProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HaikuVerseProcessor::new(false);
